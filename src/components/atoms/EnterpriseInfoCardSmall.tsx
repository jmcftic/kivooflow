...
// SVG Background para el componente pequeño - basado en el grande pero escalado
...
// SVG Chart para la gráfica en la parte inferior derecha del componente pequeño - color rojo
const SmallChartSVG = ({ uniqueId }: { uniqueId: string }) => (
  <svg 
    width="100%" 
    height="100%" 
    viewBox="0 0 195 114" 
  ...
  >
    ...
    <defs>
      <linearGradient id={`paint0_linear_small_chart_${uniqueId}`} x1="44.6496" y1="23.7972" x2="44.6496" y2="90" gradientUnits="userSpaceOnUse">
      ...
      {showChart && (
        <div 
          ...
          style={{ 
            bottom: '0',
            right: '0',
            width: 'min(195px, calc(100% - 48px))',
            height: '114px',
            zIndex: 5
          }}
        >
          <SmallChartSVG uniqueId={uniqueId} />
        </div>
      )}
    </div>
  )
